...
AI system to detect manipulated videos and store authenticity proof using blockchain for tamper resistance.

**Tech:** Python, ViT, Blockchain, FastAPI


### 🗄 CyberCrimeRecords Classification System
